...
Seam: **Attestation verifier**.

Verify remote attestation / confidential-computing evidence (Intel TDX, AMD SEV-SNP) and feed the trust result to the kernel. Experimental.
